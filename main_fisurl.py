...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_banks', type=int, default=64, help='Number of banks to use')
    ...
    args.use_softmax = args.use_softmax.lower() == 'true'
    args.use_rl = args.use_rl.lower() == 'true'
