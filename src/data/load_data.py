...
def load_data(args):
    if args.dataset == 'synthetic':
        ...
        test_loader = DataLoader(TensorDataset(test_data, test_labels.unsqueeze(0) if test_labels.dim() == 0 else test_labels), batch_size=args.signal_batch_size if args.signal_batch_size else 64)
        ...
        test_loader = DataLoader(test_dset, batch_size=args.signal_batch_size if args.signal_batch_size else 10, shuffle=False)
