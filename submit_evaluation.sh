...
python main_evaluation.py --dataset AudioMNIST --labeltype gender --synth_sig_len 100 --n_samples 10 --compute_complexity_scores --compute_deletion_scores
